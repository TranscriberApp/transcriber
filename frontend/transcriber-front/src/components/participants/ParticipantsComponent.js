...
function renderParticipant(participant) {
    return (
        <div className={"participant-container"}>
            <Avatar shape="round" icon={<UserOutlined/>} style={{verticalAlign: 'middle'}}/>
...
export class ParticipantsComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            participants: [{username: "myrmarachne"}, {username: "Itachi"}, {username: "Kira"}]
        }
    }
        ...
        return (
            <div className={"participants-list-container"}>
                <List
                    ...
                    renderItem={item => <List.Item>{renderParticipant(item)}</List.Item>}
                />
            </div>
        )
    }
